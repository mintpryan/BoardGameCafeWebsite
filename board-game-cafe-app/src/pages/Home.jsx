    ...
    <>
      <HomeMain>
        <ResponsiveDesktopAnalog>
          ...
          <HeroContainer>
            <HeroTitle>
              Click at cards!<br></br>Learn more about us!
              <br></br>
              
            </HeroTitle>
            
            <CardGrid slides={slides} colors={colors}></CardGrid>
        ...
        <Section>
          ...
          <CardComponent
            ...
            text={
              <>
                New opening hours: <br></br>Sunday: 10am-11pm Mon-Thurs:
          ...
          <CardComponent
            ...
            text={
              <>
                <a href="https://docs.google.com/spreadsheets/d/1-TOvwUh-ziCB6QmLYvQlxtXuBd-aGiiO72GWAasby8o/edit?gid=0#gid=0">
                  <b>
                    <u>Our extensive library</u>
                  </b>
                </a>{" "}
